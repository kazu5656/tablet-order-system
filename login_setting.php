...
<html lang="ja">
    ...
    <head>
        ...
        <!-- title  -->
        <title>設定メニューログイン| <?php echo SERVICE_NAME; ?></title>

        <!-- favicon -->

        <link rel="icon" href="images/tablet_order_system_favicon.ico">
        <link rel="apple-touch-icon" sizes="180x180" href="images/apple-touch-icon_tablet-order-system_setthing.JPG">
        <link rel="apple-touch-icon" href="images/apple-touch-icon_tablet-order-system_setthing.JPG">
        <link rel="apple-touch-icon" sizes="72x72" href="images/apple-touch-icon_tablet-order-system_setthing.JPG">
        <link rel="apple-touch-icon" sizes="114x114" href="images/apple-touch-icon_tablet-order-system_setthing.JPG">
