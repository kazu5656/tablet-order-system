...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    ...
    if (empty($err)) {
        ...
        header('Location: '.SITE_URL.'index_experience_account_update.php');
...
<html lang="ja">
    ...
    <head>
        ...
        <!-- title  -->
        <title>アカウント修正ログイン| <?php echo SERVICE_NAME; ?></title>
    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="section-heading margin-50px-top md-margin-70px-top sm-margin-50px-top">
                <h1>アカウント修正ログイン</h1>
                <p>このページからログインし<br class="br-携帯短" />必要な情報を追加することで、<br>無料体験期間終了後もデータが消去されず<br class="br-携帯短" />スムーズに新規登録が可能です。</p>
            </div>
