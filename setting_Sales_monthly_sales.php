...
//本日から過去10ヵ月の日付を取得（パラメーター用）
$year_month_0 = date('Y-m');

for ($i = 1; $i <= 12; $i=$i+1){
    ${'year_month_'.$i} = date('Y-m', strtotime("-$i month", time()));;
}
...
for ($i = 0; $i <= 11; $i=$i+1){
    $s = $i-1;
    // 3月が２つ存在する場合
    if(${'year_month_'.$i} == ${'year_month_'.$s}){
        $march=${'year_month_'.$s};
        // 一つ目の3月を2月に変更する
        ${'year_month_'.$i} = date('Y-m',strtotime($march . "-1 m"));
    }
}
...
<html lang="ja">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>月別メニュー | <?php echo SERVICE_NAME; ?></title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="panel-body">
                    <h1>月別データ</h1>
                    <p>過去12ヵ月間の売上記録を見ることができます。</p>
                    <hr>

                    <div class="btn-group btn-group-justified" role="group">
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_11); ?>" class="btn btn-default" role="button"><?php echo h($year_month_11); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_10); ?>" class="btn btn-default" role="button"><?php echo h($year_month_10); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_9); ?>" class="btn btn-default" role="button"><?php echo h($year_month_9); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_8); ?>" class="btn btn-default" role="button"><?php echo h($year_month_8); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_7); ?>" class="btn btn-default" role="button"><?php echo h($year_month_7); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_6); ?>" class="btn btn-default" role="button"><?php echo h($year_month_6); ?></a>
                    </div>
                    <div class="btn-group btn-group-justified" role="group">
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_5); ?>" class="btn btn-default" role="button"><?php echo h($year_month_5); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_4); ?>" class="btn btn-default" role="button"><?php echo h($year_month_4); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_3); ?>" class="btn btn-default" role="button"><?php echo h($year_month_3); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_2); ?>" class="btn btn-default" role="button"><?php echo h($year_month_2); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_1); ?>" class="btn btn-default" role="button"><?php echo h($year_month_1); ?></a>
                      <a href="setting_Sales_monthly_sales.php?id=<?php echo h($year_month_0); ?>" class="btn btn-default" role="button"><?php echo h($year_month_0); ?></a>
                    </div><br>
