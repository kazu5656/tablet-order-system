...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    ...
    if (empty($err)) {
        ...
        $sql = "insert into user
            (user_name,user_email,order_pc_email,user_password,photo_directory,experience,created_at,updated_at)
            values
            (:user_name,:user_email,:order_pc_email,:user_password,:photo_directory,:experience,now(), now())";
        ...
        mb_language("japanese");
        mb_internal_encoding("UTF-8");
        $mail_title = '無料体験登録ありがとうございます。';
        $mail_body = $user_name. ' 様'.PHP_EOL.PHP_EOL;
        $mail_body.= 'この度は【TABLET ORDER SYSTEM】の無料体験をご登録いただきまして、誠にありがとうございます。'.PHP_EOL.PHP_EOL;
        ...
        header('Location: '.SITE_URL.'index_Experience_signup_complete.php');
...
<html lang="ja">
    ...
    <head>
        ...
        <!-- title  -->
        <title>無料体験ユーザー登録 | <?php echo SERVICE_NAME; ?></title>
                        ...
                        <div class="col-md-12">
                            ...
                            <form id="demo_form"method="POST" class="panel panel-default panel-body" >
                                ...
                                <div class="form-group <?php if (isset($err['user_name']) && $err['user_name'] != '') echo 'has-error'; ?>">
                                    ...
                                    <input class="validate[required]" type="text" name="user_name" size="80" value="<?php echo h($user_name) ?>" placeholder="氏名(15文字以内)" />
                                ...
                                <div class="form-group <?php if (isset($err['user_password']) && $err['user_password'] != '') echo 'has-error'; ?>"><span class="help-block"><?php echo h($err['user_phone_number']); ?></span>
                                    ...
                                    <input class="validate[required]" type="password" name="user_password" size="80"value="<?php echo h($user_password) ?>" placeholder="パスワード(6文字以上)" />
