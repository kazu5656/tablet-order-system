...
<html lang="ja">
    ...
    <head>
        ...
        <!-- title  -->
        <title>500 設定画面| <?php echo SERVICE_NAME; ?></title>
        ...
        <div class="main-wrapper">
            ...
            <section class="box-hover bg-black margin-90px-bottom md-margin-70px-bottom sm-margin-50px-bottom">
                <div class="container text-center">
                    <div class="row">
                        <div class="col-md-12">
                            <h6>大変ご迷惑をおかけしております。<br>一時的なサーバーエラーが発生しています。
                              <br>自動復旧いたしますので、3分後に<br>「設定メニューに戻る」もしくは「HOMEに戻る」を押して下さい。<br>
                              （各種データなどには問題ありませんのでご安心下さい。）
                            </h6>
