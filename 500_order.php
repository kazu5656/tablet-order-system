...
<html lang="ja">
    ...
    <head>
        ...
        <!-- title  -->
        <title>500 注文画面| <?php echo SERVICE_NAME; ?></title>
        ...
        <div class="main-wrapper">
            ...
            <section class="box-hover bg-black margin-90px-bottom md-margin-70px-bottom sm-margin-50px-bottom">
                <div class="container text-center">
                    <div class="row">
                        <div class="col-md-12">
                            <h6>大変ご迷惑をおかけしております。<br>一時的なサーバーエラーが発生しています。<br>
                              お手数ですが従業員をお呼び下さい。
                            </h6>
                          <a href="order.php" id="注文画面へ" class="btn btn-primary btn-block" role="button" >注文画面に戻る</a>
                        </div><!-- col-md-12 -->
                    </div><!-- row -->
                </div><!-- container -->
            </section>
