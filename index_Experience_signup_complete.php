...
$today = date('Y-m-d');
$seven_days_after = date('Y-m-d', strtotime("+6 day", time()));
...
<html lang="ja">
    ...
    <head>
        ...
        <!-- title  -->
        <title>無料体験登録完了 | <?php echo SERVICE_NAME; ?></title>
        ...
        <div class="main-wrapper">
            ...
            <section class="box-hover bg-black margin-90px-bottom md-margin-70px-bottom sm-margin-50px-bottom">
                <div class="container text-center">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 id="ありがとう">TABLET ORDER SYSTEM 無料体験を<br>ご登録いただきありがとうございます。
                            <br>本日<?php echo h($today) ?>から<?php echo h($seven_days_after) ?>まで<br class="br-携帯短" />ご利用いただけます。<br>
                            無料体験登録完了メールをご確認下さい。</h3>
                        </div><!-- col-md-12 -->
                    </div><!-- row -->
